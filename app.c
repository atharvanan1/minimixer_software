    ...
    switch (BGLIB_MSG_ID(evt->header)) {
      ...
      case gecko_evt_gatt_server_attribute_value_id:
    	  ...
    	  if (evt->data.evt_gatt_server_user_write_request.characteristic == gattdb_xgatt_midi) {
    	      ...
    	      printLog("Value - %d", evt->data.evt_gatt_server_attribute_value.value.data[0]);
    	      printLog("Value - %d", evt->data.evt_gatt_server_attribute_value.value.data[1]);
    	      printLog("Value - %d", evt->data.evt_gatt_server_attribute_value.value.data[2]);
