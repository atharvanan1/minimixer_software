...
uint8_t bg_gattdb_data_attribute_field_14_data[8]={0x4d,0x69,0x6e,0x69,0x6d,0x69,0x78,0x65,};
...
GATT_DATA(const struct bg_gattdb_attribute bg_gattdb_data_attributes_map[])={
    ...
    {.uuid=0x8001,.permissions=0x805,.caps=0xffff,.datatype=0x02,.dynamicdata=&bg_gattdb_data_attribute_field_10},
